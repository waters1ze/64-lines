# Project: Шахматная школа 64 линии
...
|---|------|-------|-------------|--------|
| M1 | Chat History Management | Implement `/api/chat/delete`, `/api/cron/cleanup-messages` and button fix in `ChatComponent.tsx` | None | PLANNED |
...
| M5 | E2E Testing Suite | Dual track: design and create the E2E test suite (Tiers 1-4) | None | PLANNED |
| M6 | E2E Verification | Run E2E tests, debug and verify all feature components | M1, M2, M3, M4, M5 | PLANNED |
| M7 | Adversarial Hardening | Tier 5 white-box coverage and adversarial tests | M6 | PLANNED |
